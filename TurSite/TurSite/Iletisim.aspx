<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Iletisim.aspx.cs" Inherits="TurSite.Iletisim" %>
...
<head>
    <title>Rambling A Travel Category Bootstrap Responsive website Template | Contact :: w3layouts</title>
...
<body>
    ...
    <nav id="menu" class="panel">
        <ul>
            ...
            <li>
                <a href="contact.aspx" class="active">İLETİŞİM</a>
            </li>
    ...
    <section class="banner-bottom-w3ls pt-lg-5 pt-md-3 pt-3">
        <div class="inner-sec-wthreelayouts pt-md-5 pt-md-3 pt-3">
            <h2 class="tittle mb-xl-5 mb-4 text-center">
					<span class="text-uppercase">İLETİŞİM</span>İletişimde kal</h2>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-6 main_grid_contact">
                        <div class="form">
                            <h4 class="mb-4 text-left">Mesaj gönder</h4>
...
<!--footer-->
			...
			<div class="inner-sec-w3ls-agileits py-lg-5 py-3">
					...
					<div class="col-lg-4 footer-grid text-left">
						<div class="tech-btm">
							...
							<div class="blog-grids row mb-3">
								<div class="col-sm-4 pr-0 blog-grid-left">
									<a href="about.html">
										<img src="web/images/g4.jpg" class="img-fluid" alt="">
									</a>
								</div>
								<div class="col-sm-8 blog-grid-right">
				...
				<div class="footer-cpy text-center pt-5 mt-5">
					<div class="copyrightbottom-w3ls-agile">
						<p>© 2018 Rambling. All Rights Reserved | Design by
    ...
    <script src="web/js/form-validation.js"></script>
